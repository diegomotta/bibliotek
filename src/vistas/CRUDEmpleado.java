...
private ControladorPrincipal controladorPrincipal;
     ...
     */
    public CRUDEmpleado(ControladorPrincipal controladorPrincipal) {
        this.controladorPrincipal = controladorPrincipal;
        initComponents();
        this.cargarTablaEmpleado(jTable1, this.controladorPrincipal.getControladorPersona().getEmpleados());
    ...
    public void cargarTablaEmpleado(JTable tabla, ArrayList lista){
        limpiar_tabla(tabla);
    ...
    private void initComponents() {
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 109, 400));
        ...
        add(pnl_Cuerpo, new org.netbeans.lib.awtextra.AbsoluteConstraints(115, 0, 485, 400));
    ...
    private void btn_opcionesHabitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_opcionesHabitacionActionPerformed
        FormEmpleado formempleado = new FormEmpleado(controladorPrincipal, jTable1,pnl_Cuerpo, null);
        pnl_Cuerpo.removeAll();
        pnl_Cuerpo.add(formempleado);
        pnl_Cuerpo.updateUI();
    ...
    private void btn_opcionesPiletaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_opcionesPiletaActionPerformed
        ...
        if(this.jTable1.getSelectedRow()!=-1)
        {
            ...
            Integer unEmpleadoSeleccionado = (Integer) this.jTable1.getValueAt(fila, 0);
            Empleado unEmpleado =  this.controladorPrincipal.getControladorPersona().buscarEmpleado(unEmpleadoSeleccionado);
            FormEmpleado empleadoForm = new FormEmpleado(controladorPrincipal, jTable1,pnl_Cuerpo, unEmpleadoSeleccionado);
            pnl_Cuerpo.removeAll();
            pnl_Cuerpo.add(empleadoForm);
            pnl_Cuerpo.updateUI();
        }
        else
        {
            JOptionPane.showMessageDialog(null,"No ha seleccionado un Empleado"," ",JOptionPane.ERROR_MESSAGE);
        }
